...
public class ProblumEXTests {
    ...
    /* index. 1번 문제 확인 */
    @Test
    @DisplayName("직접 SQL 문을 작성해서 메뉴 조회 시 문제 학인")
    void testDirectSQL() throws SQLException {
        ...
        while (rset.next()) {           //rset.next() = rset에 다음요소가 있을 때 까지 반복
            Menu menu = new Menu();
    ...
    *  */
    ...
    /* index. 4. 동일성 보장의 문제 */
    @Test
    @DisplayName("조회한 두 개의 행을 담는 객체의 동일성 비교")
    void testEquals() throws SQLException {

        String query = "SELECT MENU_CODE, MENU_NAME FROM TBL_MENU WHERE MENU_CODE = 5";
